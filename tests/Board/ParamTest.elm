module Board.ParamTest exposing (..)
...
{- Test ParsingResult to Result String Board.Params translation
Basic ParsingResult to Board.Params converstion is straightforward,
